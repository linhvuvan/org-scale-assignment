...
export type Step<TIn extends R = R, TOut extends R = R> = (arg: {
  req: Request;
  res: Response;
  ctx: TIn;
}) => Promise<TOut | null>;
...
export function pipe(
  req: Request,
  res: Response,
  t: (arg: { req: Request; res: Response; ctx: Record<string, never> }) => Promise<void>,
): Promise<void>;
export function pipe<O1 extends R>(
  req: Request,
  res: Response,
  s1: Step<{}, O1>,
  t: (arg: { req: Request; res: Response; ctx: O1 }) => Promise<void>,
): Promise<void>;
export function pipe<O1 extends R, O2 extends R>(
  req: Request,
  res: Response,
  s1: Step<{}, O1>,
  s2: Step<O1, O2>,
  t: (arg: { req: Request; res: Response; ctx: O1 & O2 }) => Promise<void>,
): Promise<void>;
export function pipe<O1 extends R, O2 extends R, O3 extends R>(
  req: Request,
  res: Response,
  ...
  s2: Step<O1, O2>,
  s3: Step<O1 & O2, O3>,
  t: (arg: { req: Request; res: Response; ctx: O1 & O2 & O3 }) => Promise<void>,
): Promise<void>;
export function pipe<O1 extends R, O2 extends R, O3 extends R, O4 extends R>(
  req: Request,
  res: Response,
  ...
  s3: Step<O1 & O2, O3>,
  s4: Step<O1 & O2 & O3, O4>,
  t: (arg: { req: Request; res: Response; ctx: O1 & O2 & O3 & O4 }) => Promise<void>,
): Promise<void>;
export function pipe<
  O1 extends R,
  O2 extends R,
...
export async function pipe(
  ...
  res: Response,
  ...steps: Array<
    Step | ((arg: { req: Request; res: Response; ctx: any }) => Promise<void>)
  >
): Promise<R | null | void> {
  let ctx: R = {};
